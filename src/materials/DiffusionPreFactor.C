...
#include "DiffusionPreFactor.h"

template<>
InputParameters validParams<DiffusionPreFactor>()
{
...
DiffusionPreFactor::DiffusionPreFactor(const InputParameters & parameters) :
    Material(parameters),
...
void
DiffusionPreFactor::computeQpProperties()
{
